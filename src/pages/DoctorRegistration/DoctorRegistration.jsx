...
const DoctorRegistration = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const bmaNumber = form.bmaNumber.value;
    ...
    axios.post("/doctor/registration", submitData).then((res) => {
      ...
      <div className="py-5 border border-[#16A085] rounded p-8">
        ...
        >
          ...
          <label htmlFor="specialty">
            <span className="block mb-2 text-xs text-[#777]">Specialty</span>
            <input
              className="border border-[#16A085] rounded p-2"
              type="text"
              name="specialty"
          ...
          <label htmlFor="designation">
            <span className="block mb-2 text-xs text-[#777]">Designation</span>
            <input
              className="border border-[#16A085] rounded p-2"
              type="text"
              name="designation"
          ...
          <label htmlFor="bmaNumber">
            <span className="block mb-2 text-xs text-[#777]">BMA Number</span>
            <input
              className="border border-[#16A085] rounded p-2"
              type="text"
              name="bmaNumber"
              placeholder="BMA Number"
              required
            />
          </label>
